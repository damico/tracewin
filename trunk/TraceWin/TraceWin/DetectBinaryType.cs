...
namespace TraceWin
{
    ...
    public class DetectBinaryType
    {
        ...
        public static MachineType GetExeDllMachineType(string exePath)
        {
            ...
            if (peHead != 0x00004550) return MachineType.IMAGE_FILE_MACHINE_UNKNOWN;
